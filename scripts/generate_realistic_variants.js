...
// ── CONFIG ────────────────────────────────────────────────────────────────────
const INPUT_CSV  = path.join(__dirname, '..', 'automation', 'test-output', 'blu_test_cases_v7.csv')
const OUTPUT_CSV = path.join(__dirname, '..', 'automation', 'test-output', 'blu_test_cases_v7_realistic.csv')
